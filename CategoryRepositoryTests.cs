...
namespace Godel.AutoPartsStore.Web.Tests
{
    ...
    {
        [Fact]
        public void TestAllMethods_In_CategoryRepository()
        {
            ...
            Category getAllResult = null;
            Category getResult = null;
            ...
            using (var context = new PartsStoreDbContext(options))
            {
                ...
                IRepository<Category> rep = new CategoryRepository(context);
                var obj = new Category();
                getAllResult = rep.GetAll().FirstOrDefault();
                getResult = rep.Get(3).Result;
            ...
            // Assert
            Assert.Equal(3, getResult.Id);
            Assert.Equal(1, getAllResult.Id);
        ...
        private DbContextOptions<PartsStoreDbContext> CreateInMemoryOptions()
        {
            ...
            builder.UseInMemoryDatabase("CategoriesTestData");
